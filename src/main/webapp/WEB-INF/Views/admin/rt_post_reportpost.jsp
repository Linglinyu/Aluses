    ...
    <table class="am-table am-table-striped am-table-hover">
        ...
        <c:forEach items="${comments}" var="i">
            <tr id="r_${i.id}">
                ...
                <td>${i.uptime}</td>
                <td>
                    <select data-id="${i.id}" data-action="${path}/rt/post/reportpost/${i.id}" class="do-status">
                ...
                <td>
                    [<a class="do-delete" data-id="${i.id}" data-action="${path}/rt/post/reportpost/${i.id}" href="javascript:void(0);">删除</a>]
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<%-- <script type="text/javascript" src="${path}/assets/rt/post_reportpost.js"></script> --%>
